...
import 'package:the_weather/src/widgets/themed_button_widget.dart';
import 'package:the_weather/src/widgets/themed_modal_content_widget.dart';
...
class _CustomModalState extends State<CustomModal>
  ...
  final double _blurMultiplier = AppMetrics.BLUR_MULTIPLIER;
  double _opacity = 1.0;
                    ...
                    child: AnimatedBuilder(
                      ...
                      builder: (context, _) {
                        ...
                        return FractionalTranslation(
                          ...
                          child: Padding(
                            padding:
                                const EdgeInsets.all(AppMetrics.DEFAULT_MARGIN),
                            child: Column(
